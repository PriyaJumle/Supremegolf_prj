...
public class ProfilePayment {
	...
	public static void main(String[] args) throws Exception 
	{
		...
		*/
		...
		//dialogue box elements for delete card
		List<WebElement> carddel=driver.findElements(By.xpath("html/body/div[7]/div[2]/div/div[2]/div"));
		for(WebElement i:carddel)
		{
			System.out.println(i.getText());
		}
		System.out.println("\n");
		...
		//click on delete button or X
		if(driver.findElement(By.className("js-confirm-delete-credit-card")).isDisplayed())
		{
			driver.findElement(By.className("js-confirm-delete-credit-card")).click();
		...
		*/
		...
		Thread.sleep(8000);
		driver.findElement(By.className("close")).click();
		System.out.println("close edit card");
